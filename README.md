...
Solo es desplegar el script en Github, con el archivo.yml que contiene la instrucción de ejecutar el script de python 30 minutos antes de que sean las 12 am hora Pekín China y termina su ejecución apenas reciba una respuesta. Se tiene que poner una cookie de sesión en el archivo token.txt justo en la primera línea,ojo tienes que ponerlo o unas horas antes o justo antes de que sea ejecutado el script por github , se tienen que cambiar todos los días porque en script se ejecuta todos los días hasta que sea aceptada la solicitud 
